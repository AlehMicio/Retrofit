...
//В данном классе при помощи онлайн-конвентора имплементировано всё, что можем получить об объекте с сайта
public class Result extends BaseObservable implements Parcelable {
    ...
    public static void loadImage(ImageView imageView, String imageUrl){
        Glide.with(imageView.getContext()).load(imageUrl)
                ...
                .into(imageView); //Устанавливаем с помощью библиотеки Glide
    }
    ...
    public static final DiffUtil.ItemCallback<Result> CALLBACK = new DiffUtil.ItemCallback<Result>() {
        ...
        public boolean areContentsTheSame(@NonNull Result oldItem, @NonNull Result newItem) {
            /*
            Тут должнен быть код, который сравнивает каждый атрибут двух объектов Result
            И, соответсвенно, выводит true, если объекты полностью равны
            Для упрощения - сразу выведем true
            */
            return true;
        }
    };
